...
type SensorReading_Config struct {
	Config *SensorCheckConfig `protobuf:"bytes,20,opt,name=config,oneof"`
}

func (*SensorReading_StatefulRequest) isSensorReading_Request() {}
func (*SensorReading_Config) isSensorReading_Request()          {}
...
func (m *SensorReading) GetConfig() *SensorCheckConfig {
	if x, ok := m.GetRequest().(*SensorReading_Config); ok {
		return x.Config
	}
	return nil
}
...
func _SensorReading_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 10: // request.stateful_request
		...
		return true, err
	case 20: // request.config
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(SensorCheckConfig)
		err := b.DecodeMessage(msg)
		m.Request = &SensorReading_Config{msg}
		return true, err
	default:
		return false, nil
	}
...
type StatefulSensorRequest struct {
	...
	Config *SensorCheckConfig `protobuf:"bytes,2,opt,name=config" json:"config,omitempty"`
}
...
func (*SensorCheckConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
var fileDescriptor0 = []byte{
	...
	,
}
